...
/*
 * Created by Taehyung Kim on 2021-03-15
 */
class ClippingView @JvmOverloads constructor(
    ...
    private fun drawClippedRectangle(canvas: Canvas) {
        LogT.d("clipRectLeft : $clipRectLeft")
        LogT.d("clipRectTop : $clipRectTop")
        LogT.d("clipRectRight : $clipRectRight")
        LogT.d("clipRectBottom : $clipRectBottom")
        canvas.clipRect(
            clipRectLeft, clipRectTop,
            clipRectRight, clipRectBottom
        )
        ...
        LogT.d("circleRadius : $circleRadius")
        LogT.d("clipRectBottom - circleRadius : ${clipRectBottom - circleRadius}")
        paint.color = Color.GREEN
        canvas.drawCircle(
            circleRadius, clipRectBottom - circleRadius,
            circleRadius, paint
